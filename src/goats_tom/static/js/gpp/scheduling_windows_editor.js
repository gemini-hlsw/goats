...
class SchedulingWindowsEditor {
   ...
   * @param {{data?: Array<Object>, idPrefix?: string, readOnly?: boolean}} [options]
  ...
  constructor(
    parentElement,
    { data = [], idPrefix = "scheduling-windows", readOnly = false } = {},
  ) {
  ...
  #buildFromControls() {
    ...
    fromInput.disabled = this.#readOnly;
  ...
  #buildRepeatBlock() {
    ...
    periodInput.disabled = this.#readOnly;
    const suffix = Utils.createElement("span", ["input-group-text"]);
    suffix.textContent = "hours";
    ...
    foreverInput.disabled = this.#readOnly;
    ...
    timesRadio.disabled = this.#readOnly;
    ...
    timesCountInput.disabled = this.#readOnly;
  ...
  #wireModeBehavior() {
    ...
    const updateTimesInputState = () => {
      ...
      timesCountInput.disabled = !shouldEnableTimes || this.#readOnly;
    ...
    const updateRepeatVisibility = (enabled) => {
      ...
      if (repeatBlock) {
        ...
        repeatInputs.forEach((input) => {
          ...
          input.disabled = !enabled || this.#readOnly;
        });
      }
