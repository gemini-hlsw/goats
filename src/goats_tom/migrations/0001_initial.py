# Generated by Django 4.2.25 on 2025-12-05 18:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reduction_mode', models.CharField(choices=[('sq', 'Science-quality (sq)'), ('ql', 'Quick look (ql)'), ('qa', 'Quality assurance (qa)')], default='sq', help_text='DRAGONS reduction mode passed to reduce_data(mode=...).', max_length=4)),
                ('drpkg', models.CharField(choices=[('geminidr', 'geminidr')], default='geminidr', help_text='Data reduction package passed to reduce_data(drpkg=...).', max_length=32)),
                ('additional_files', models.JSONField(blank=True, default=None, help_text='Additional FITS files to pass to reduce_data(files=...), stored as a list of paths relative to the target directory.', null=True)),
                ('ucals', models.JSONField(blank=True, default=None, help_text='Calibration overrides passed to reduce_data(ucals=...), stored as a mapping of calibration type to file path.', null=True)),
                ('suffix', models.CharField(blank=True, default=None, help_text='Optional suffix passed to reduce_data(suffix=...).', max_length=64, null=True)),
