# Generated by Django 4.2.25 on 2025-12-05 23:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_files', models.TextField(blank=True, help_text='Additional FITS files to pass to reduce_data(files=...), stored as a list of paths relative to the target directory.', null=True)),
                ('ucals', models.TextField(blank=True, help_text='Calibration overrides passed to reduce_data(ucals=...), stored as a mapping of calibration type to file path.', null=True)),
